...
export default function TigerGuide() {
  return (
    <div className="tiger-guide-shell">
      <div className="tiger-guide">
        ...
        >
          ...
          {/* Head Shape */}
          <path
            d="M40 100 C40 40, 160 40, 160 100 C180 160, 20 160, 40 100 Z"
            fill="url(#tigerGrad)"
          />
          {/* Ears */}
          <path
            d="M40 70 L20 20 L80 50 Z"
            fill="url(#tigerGrad)"
            stroke="#1f2937"
            strokeWidth="4"
          />
          <path
            d="M160 70 L180 20 L120 50 Z"
            fill="url(#tigerGrad)"
            stroke="#1f2937"
            strokeWidth="4"
          />
          ...
          {/* Muzzle */}
          <path
            d="M100 150 C110 160, 120 150, 120 150"
            stroke="#1f2937"
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M100 150 C90 160, 80 150, 80 150"
            stroke="#1f2937"
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
      ...
      <div className="timeline-content tiger-bubble">
        <div className="tiger-bubble-arrow"></div>
        <h3
          style={{
            color: "#a7f3d0",
            fontSize: "1.75rem",
        ...
        >
          I am your personal AI guide to the Dandeli jungle. I'm not a regular
          search engine—I'm a 70-Billion parameter intelligent agent.
        </p>
        <p style={{ color: "#ecfdf5", margin: 0, fontSize: "1.15rem" }}>
          Skip the frustrating aggregators. Just chat with me! I'll instantly
          scour verified local data to find the absolute best resorts and
          activities for you, and I'll even book them directly via WhatsApp with
          zero platform fees.
        </p>
      </div>
    </div>
